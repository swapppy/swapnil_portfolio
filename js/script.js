...
var songs = ['songs/song1.mpeg', 'songs/song2.mpeg', 'songs/song3.mpeg', 'songs/song4.mpeg']


// ------------- Play  Sound --------------

const audio = new Audio();
audio.src = random_item(songs);

const play = document.querySelector('.about-content p a');
